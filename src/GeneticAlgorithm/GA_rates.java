...
public class GA_rates {
    private static final double crossoverRate = 0.5;//0.5
    private static final double mutationRate = 0.01; //0.01, 0.05, 0.00
    private static final int tournamentSize = 2; //2
    private static final boolean superiority = true; // Choose the best
